...
require (
	github.com/azuridayo/pear-desktop-twitch-song-requests/gen/pearsdk v0.0.0-00010101000000-000000000000
...
replace github.com/azuridayo/pear-desktop-twitch-song-requests/gen/pearsdk => ./gen/pearsdk
