...
# migrate
go install -tags 'sqlite' github.com/golang-migrate/migrate/v4/cmd/migrate@v4
migrate -path internal/data/iofs/migrations -database sqlite://pear-desktop-twitch-song-requests.db up
